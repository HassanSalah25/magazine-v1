...
$(document).ready(function(){
    ...
    toggle.on('click', function() {
        ...
        nav_open = $('html').hasClass('nav_open') ? 1 : 0;
    });
    toggle_sidebar = true;
}
	...
	if(!minimize_sidebar){
		...
		if($('.wrapper').hasClass('sidebar_minimize')){
			...
			minibutton.html('<i class="icon-options-vertical" style="color:black;" ></i>');
		}
		...
		minibutton.on('click', function() {
			if (mini_sidebar == 1) {
				...
				minibutton.html('<i class="icon-menu" style="color:black;"></i>');
				mini_sidebar = 0;
			} else {
	...
	if(!toggle_overlay_sidebar){
		...
		if($('.wrapper').hasClass('is-show')){
			...
			overlaybutton.html('<i class="icon-options-vertical" style="color:black;" ></i>');
		}
		...
		overlaybutton.on('click', function() {
			if (overlay_sidebar_open == 1) {
				...
				overlaybutton.html('<i class="icon-menu" style="color:black;"></i>');
				overlay_sidebar_open = 0;
			} else {
