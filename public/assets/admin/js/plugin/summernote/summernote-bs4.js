...
function () {
  function Editor(context) {
    ...
    this.createLink = this.wrapCommand(function (linkInfo) {
      ...
      var linkClass = linkInfo.className;
      var linkId = linkInfo.id;
      ...
      external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.each(anchors, function (idx, anchor) {
        var $anchor = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(anchor);
        ...
        if (linkClass) {
          $anchor.attr('class', linkClass);
        } else {
          $anchor.removeAttr('class');
        }

        if (linkId) {
          $anchor.attr('id', linkId);
        } else {
    ...
    */
    ...
    value: function getLinkInfo() {
      ...
      if ($anchor.length) {
        ...
        linkInfo.title = $anchor.attr('title') || '';
        linkInfo.rel = $anchor.attr('rel') || '';
        linkInfo.className = $anchor.attr('class') || '';
        linkInfo.id = $anchor.attr('id') || '';
      }
...
function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var body = ['<div class="form-group note-form-group">', "<label for=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.textToDisplay, "</label>"), "<input id=\"note-dialog-link-txt-".concat(this.options.id, "\" class=\"note-link-text form-control note-form-control note-input\" type=\"text\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.url, "</label>"), "<input id=\"note-dialog-link-url-".concat(this.options.id, "\" class=\"note-link-url form-control note-form-control note-input\" type=\"text\" value=\"http://\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-title-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.title, "</label>"), "<input id=\"note-dialog-link-title-".concat(this.options.id, "\" class=\"note-link-title form-control note-form-control note-input\" type=\"text\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-rel-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.rel, "</label>"), "<input id=\"note-dialog-link-rel-".concat(this.options.id, "\" class=\"note-link-rel form-control note-form-control note-input\" type=\"text\" placeholder=\"e.g., nofollow, noopener, noreferrer\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-class-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.className, "</label>"), "<input id=\"note-dialog-link-class-".concat(this.options.id, "\" class=\"note-link-class form-control note-form-control note-input\" type=\"text\"/>"), '</div>', '<div class="form-group note-form-group">', "<label for=\"note-dialog-link-id-".concat(this.options.id, "\" class=\"note-form-label\">").concat(this.lang.link.id, "</label>"), "<input id=\"note-dialog-link-id-".concat(this.options.id, "\" class=\"note-link-id form-control note-form-control note-input\" type=\"text\"/>"), '</div>', !this.options.disableLinkTarget ? external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div/>').append(this.ui.checkbox({
    ...
    value: function showLinkDialog(linkInfo) {
      ...
      return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.Deferred(function (deferred) {
        ...
        var $linkClass = _this.$dialog.find('.note-link-class');

        var $linkId = _this.$dialog.find('.note-link-id');
        ...
        _this.ui.onDialogShown(_this.$dialog, function () {
          ...
          $linkClass.val(linkInfo.className || '');
          $linkId.val(linkInfo.id || '');
