...
$(".nav-search .input-group > input")
    ...
    $(document).ready(function () {
        ...
        if (!g) {
            ...
            $(".wrapper").hasClass("sidebar_minimize") && ((v = 1), k.addClass("toggled"), k.html('<i class="icon-options-vertical" style="color:black;" ></i>')),
                k.on("click", function () {
                    1 == v
                        ? ($(".wrapper").removeClass("sidebar_minimize"), k.removeClass("toggled"), k.html('<i class="icon-menu" style="color:black;"></i>'), (v = 0))
                        : ($(".wrapper").addClass("sidebar_minimize"), k.addClass("toggled"), k.html('<i class="icon-options-vertical" style="color:black;" ></i>'), (v = 1)),
                        $(window).resize();
                }),
                (g = !0);
        }
        ...
        $(".wrapper").hasClass("is-show") && ((b = 1), y.addClass("toggled"), y.html('<i class="icon-options-vertical" style="color:black;" ></i>')),
            y.on("click", function () {
                1 == b
                    ? ($(".wrapper").removeClass("is-show"), y.removeClass("toggled"), y.html('<i class="icon-menu" style="color:black;"></i>'), (b = 0))
                    : ($(".wrapper").addClass("is-show"), y.addClass("toggled"), y.html('<i class="icon-options-vertical" style="color:black;" ></i>'), (b = 1)),
                    $(window).resize();
            }),
            (g = !0),
            $(".sidebar").hover(
