...
class UpdateServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'parent_category_id' => 'required|integer|exists:service_categories,id',
            'sub_category_id' => 'required|integer|exists:service_categories,id',
        ];
        ...
        foreach ($locales as $locale) {
            ...
            $translation = $this->route('service')?->translations->firstWhere('locale', $locale);
            ...
            $rules["$locale.slug"] = [
                ...
                'string',
                Rule::unique('service_translations', 'slug')->ignore($translationId),
                new LowercaseSlug,
            ];
