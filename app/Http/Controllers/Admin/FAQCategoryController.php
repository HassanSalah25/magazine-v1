...
class FAQCategoryController extends Controller
{
  ...
  public function bulkDelete(Request $request)
  {
    ...
    {
        $faq_category = FaqCategory::find($request->category_id);
        $faq_category->show_in = $request->show_in;
        $faq_category->save();

        if ($request->show_in == 1) {
            Session::flash('success', 'Showed in Home successfully!');
        } else {
            Session::flash('success', 'Showed in Our Story successfully!');
        }
