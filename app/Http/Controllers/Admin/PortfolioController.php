...
class PortfolioController extends Controller
{
  ...
  public function edit($id)
  {
    ...
    $data['services'] = Scategory::where('language_id', $data['portfolio']->language_id)->get();
  ...
  public function store(Request $request)
  {
    ...
    $messages = [
        ...
        'scategories.required' => 'At least one category is required',
    ];
    ...
    if ($request->filled('client_image')) {
      ...
      @copy($client_image, 'assets/front/img/portfolios/featured/' . $clientFilename);
      $in['client_image'] = $clientFilename;
    }

    $portfolio = Portfolio::create($in);

    $portfolio->scategories()->sync($request->input('scategories', []));
  ...
  public function update(Request $request)
  {
    ...
    if ($request->filled('image')) {
      ...
      if ($request->filled('client_image')) {
          @unlink('assets/front/img/portfolios/featured/' . $portfolio->client_image);
          $clientFilename = uniqid() . '.' . $extClientImage;
          @copy($client_image, 'assets/front/img/portfolios/featured/' . $clientFilename);
          $in['client_image'] = $clientFilename;
      }
