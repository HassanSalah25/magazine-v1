...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($cols as $key => $value) {
            ...
            if ($key == 'hero_bg') {
                // take default lang image
                $dimg = public_path('/assets/front/img/') . '/' . $dbs->hero_bg;
            ...
            if ($key == 'intro_bg') {
                // take default lang image
                $dimg = public_path('/assets/front/img/') . '/' . $dbs->intro_bg;
            ...
            if ($key == 'cta_bg') {
                // take default lang image
                $dimg = public_path('/assets/front/img/') . '/' . $dbs->cta_bg;
            ...
            if ($key == 'team_bg') {
                // take default lang image
                $dimg = public_path('/assets/front/img/') . '/' . $dbs->team_bg;
            ...
            if ($key == 'announcement') {
                // take default lang image
                $dimg = public_path('/assets/front/img/') . '/' . $dbs->announcement;
