...
class FeatureController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Feature::where('language_id', $lang_id);
        ...
        $data['features'] = $query->orderBy('id', 'DESC')->get();
    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('page_id')) {
            $be = BasicExtended::where('language_id', $request->language_id)
        ...
        $feature->percent_value = $request->percent_value;
        $feature->page_id = $request->id;
        $feature->save();
