                                    ...
                                    <div class="table-responsiv">
                                        <table id="packagesTable" class="dataTables_wrapper dt-responsive table-striped dt-bootstrap4" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$package->title}}</td>
                                                    <td>{{$bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : ''}} {{(int)$package->price}} {{$bex->base_currency_symbol_position == 'right' ? $bex->base_currency_symbol : ''}}</td>
                                                    <td>{{$package->duration == 'quarterly' ? __('Quarterly') : __('Yearly')}}</td>
                                                    @if ($activeSub->count() > 0 && empty($activeSub->first()->next_package_id))
                                                        <td>
