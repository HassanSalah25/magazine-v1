                    ...
                    @foreach ($packages as $key => $package)
                        <div class="pricing_box text-center">
                            ...
                            <div class="pricing_price">
                                <h2 style="margin-bottom: 0px;">{{$bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : ''}} {{(int)$package->price}} {{$bex->base_currency_symbol_position == 'right' ? $bex->base_currency_symbol : ''}}</h2>
                            </div>
