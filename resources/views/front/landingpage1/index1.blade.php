@extends('front.landingpage1.layout')
...
@section('content')
    <!--   hero area start   -->
    @include('front.landingpage1.partials.slider')
    <!--   hero area end    -->
    ...
    <span class="gl-featured-shape position-absolute">
        ...
        <div class="container">
            ...
            <span class="gl-featured-shape2 position-absolute" data-parallax='{"x" : -70}'>
                ...
                <div class="row">
                    @foreach ($features as $index => $feature)
                        <div class="col-lg-3 col-md-6 headline wow fadeInUp" data-wow-delay="{{ $index * 200 }}ms" data-wow-duration="1500ms">
            ...
            @if(!empty($bs->feature_section_cta_text) && !empty($bs->feature_section_cta_link))
                <div class="gl-featured-more d-flex justify-content-end headline wow fadeInRight" data-wow-delay="800ms" data-wow-duration="1500ms">
                <span>
                    {{ convertUtf8($bs->feature_section_cta_text) }}
                    <a class="text-uppercase" href="{{ $bs->feature_section_cta_link }}">{{ __('Find Your Solution') }}</a>
                </span>
                </div>
            @endif
        </div>
                ...
                <div class="row">
                        ...
                        <div class="gl-about-img-wrap position-relative">
                            ...
                            <div class="gl-about-exp-text-wrap d-flex align-items-center position-absolute">
                                ...
                                <div class="gl-about-exp-text headline pera-content">
                                    <h3><span class="odometer" data-count="{{ $bs->experience_years ?? 10 }}"></span>+</h3>
                    ...
                    <div class="col-lg-6">
                        <div class="gl-about-text-wrap">
                            <div class="gl-section-title headline pera-content wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <h2>{{ convertUtf8($bs->about_title) }}</h2>
                                <p>{{ convertUtf8($bs->about_text) }}</p>
                            </div>
                            <div class="gl-about-feature-list ul-li-block wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                            ...
                            <div class="gl-about-text-area wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                {{ convertUtf8($bs->about_extra_text) }}
                            </div>
                            <div class="gl-about-text-author-details d-flex align-items-center wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
    ...
    <span class="gl-funfact-shape position-absolute">
        <img src="{{ asset('front/assets8/img/bg/fn-bg.png') }}" alt="">
            ...
            <div class="container">
                {{-- Section Title --}}
                <div class="gl-section-title headline text-center wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="gl-funfact-inner-item">
                                    <div class="thx-inner-item">
                                        ...
                                        <div class="thx-inner-title headline">
                                            <h3>
                                                <span class="odometer" data-count="{{ $stat->quantity }}">{{ $stat->quantity }}</span>
                                                {{ $stat->after ?? '' }}
                                            </h3>
                                        </div>
                                        <div class="thx-inner-text">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="gl-about-feature-text clearfix">
                            ...
                            {{-- Feature List --}}
                            <div class="gl-about-feature-list-2 clearfix ul-li-block wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <ul>
                            ...
                            @if (!empty($bs->about_feature_subscribe_text))
                                <div class="gl-about-feature-subscribe-form d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    ...
                                    <div class="gl-about-feature-subs-form position-relative">
                                        <form action="{{ route('front.subscribe') }}" method="POST">
                                            @csrf
                                            <input type="email" name="email" placeholder="{{ __('Type Your Email') }}" required>
                    ...
                    {{-- Image Section --}}
                    <div class="col-lg-6">
                        <div class="gl-about-feature-img position-relative wow fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms">
    ...
    @if ($bs->team_section == 1)
        <section id="gl-team" class="gl-team-section position-relative"
                 ...
                 @else
                     data-parallax="scroll" data-speed="0.2" data-image-src="{{ asset('assets/front/img/'.$bs->team_bg) }}"
            @endif>
            <div class="container">
                {{-- Title --}}
                <div class="gl-title-top-content headline pera-content d-flex justify-content-between align-items-center">
                    <div class="gl-title-top-head wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <div class="gl-title-top-text wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                        @if (!empty($bs->team_section_button_text) && !empty($bs->team_section_button_url))
                            <a class="d-flex justify-content-center align-items-center" href="{{ $bs->team_section_button_url }}">
                ...
                <img src="{{ asset('front/assets8/img/shape/sh3.png') }}" alt="">
                    ...
                    <div class="row justify-content-center">
                        @foreach ($members as $index => $member)
                            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="{{ $index * 200 }}ms" data-wow-duration="1500ms">
                ...
                <img src="{{ asset('front/assets8/img/shape/sh5.png') }}" alt="">
                    ...
                    <div class="row justify-content-center">
                        @foreach ($packages as $index => $package)
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="{{ $index * 200 }}ms" data-wow-duration="1500ms">
    ...
    @if(!empty($bs->feature_section_cta_text) && !empty($bs->feature_section_cta_link))
        ...
        <span>
            {{ convertUtf8($bs->feature_section_cta_text) }}
            <a class="text-uppercase" href="{{ $bs->feature_section_cta_link }}">
                {{ __('Find Your Solution') }}
            </a>
        </span>
        </div>
    @endif
