                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                            <h3 class="tp-login-title">{{__('Register')}}</h3>
                            <p>{{__('Already have an account ?')}} <span><a href="{{route('user.login')}}">{{__('Click Here')}}</a></span> {{__('to login')}}.</p>
                        </div>
                        <div class="tp-login-option">
                            ...
                            <div class="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                                ...
                                <div class="tp-login-option-item has-google">
                                    <a href="{{route('front.google.login')}}">
                                        <img src="{{ asset('front/assets/img/login/google.svg') }}" alt="">
                                ...
                                <div class="tp-login-option-item">
                                    <a href="{{route('front.facebook.login')}}">
                                        <img src="{{ asset('front/assets/img/login/facebook.svg') }}" alt="">
                                    </a>
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="tp-login-mail text-center mb-40">
                                <p>{{__('or Sign up with')}} <a href="#">{{__('Email')}}</a></p>
                            </div>
                            <form id="registerForm" action="{{route('user-register-submit')}}" method="POST">
                                ...
                                <div class="tp-login-input-wrapper">
                                    <div class="tp-login-input-box">
                                        ...
                                        <div class="tp-login-input">
                                            <input id="username" type="text" name="username" value="{{Request::old('username')}}" placeholder="{{__('Enter your username')}}">
                                        </div>
                                        @if ($errors->has('username'))
                                        <p class="text-danger mb-2 mt-2">{{$errors->first('username')}}</p>
                                        @endif
                                    </div>
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input-title">
                                        ...
                                        <div class="tp-login-input">
                                            <input id="email" type="email" name="email" value="{{Request::old('email')}}" placeholder="{{__('Enter your email')}}">
                                        </div>
                                        @if ($errors->has('email'))
                                        <p class="text-danger mb-2 mt-2">{{$errors->first('email')}}</p>
                                        @endif
                                    </div>
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input-title">
                                            <label for="tp_password">{{__('Password')}}</label>
                                        </div>
                                        <div class="tp-login-input p-relative">
                                            <input id="tp_password" type="password" name="password" placeholder="{{__('Min. 6 character')}}">
                                            <div class="tp-login-input-eye" id="password-show-toggle">
                                                ...
                                                <span id="close-eye" class="open-close" style="display:none;">
                                        ...
                                        <p class="text-danger mb-2 mt-2">{{$errors->first('password')}}</p>
                                        @endif
                                    </div>
                                    <div class="tp-login-input-box">
                                        <div class="tp-login-input-title">
                                        ...
                                        <div class="tp-login-input">
                                            <input id="password_confirmation" type="password" name="password_confirmation" placeholder="{{__('Confirm your password')}}">
                                        </div>
                                        @if ($errors->has('password_confirmation'))
                                        <p class="text-danger mb-2 mt-2">{{$errors->first('password_confirmation')}}</p>
                                        @endif
                                    </div>
                                ...
                                <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                                    <div class="tp-login-remeber">
                                        ...
                                        <label for="terms">{{__('I accept the terms of the Service & Privacy Policy.')}}</label>
                                    </div>
                                </div>
                                <div class="tp-login-bottom">
                                    <button type="submit" class="tp-login-btn w-100">{{__('Sign Up')}}</button>
                                </div>
