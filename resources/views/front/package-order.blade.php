          ...
          <div class="bg-light package-order-summary py-5 px-5">
            ...
            <ul>
              ...
              <li>
                ...
                <span
                  class="text-capitalize">{{ $package->duration == 'quarterly' ? __('Quarterly') : __('Yearly') }}</span>
              </li>
              <li>
              ...
              @php
                ...
                $activeSub = App\Models\Subscription::where('user_id', Auth::user()->id)->where('status', 1);
                if ($package->duration == 'quarterly') {
                    $days = 90;
