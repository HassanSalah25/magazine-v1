...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('front/assets9/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/fontawesome-all.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/flaticon.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/animate.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/nice-select.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/odometer-theme-default.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/video.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/jquery.mCustomScrollbar.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/slick-theme.css') }}">
    <link rel="stylesheet" href="{{ asset('front/assets9/css/slick.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css" integrity="sha512-Evv84Mr4kqVGRNSgIGL/F/aIDqQb7xQ2vcrdIwxfjThSH8CSR7PBEakCr51Ck+w+/U6swU2Im1vVX0SVk9ABhg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="{{ asset('front/assets9/css/style.css') }}">
...
<!--   header area start   -->
@include('front.landingpage2.partials.navbar')
...
<div class="modal-sidebar-scroll rts-dark-light">
    <ul>
        <li class="go-dark-w"><span>Dark</span><i class="fa-solid fa-moon"></i></li>
        <li class="go-light-w"><span>Light</span><i class="fa-solid fa-sun"></i></li>
...
<!-- For Js Library -->
<script src="{{ asset('front/assets9/js/jquery.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/popper.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/appear.js') }}"></script>
<script src="{{ asset('front/assets9/js/slick.js') }}"></script>
<script src="{{ asset('front/assets9/js/jquery.counterup.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/waypoints.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/imagesloaded.pkgd.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/jquery.filterizr.js') }}"></script>
<script src="{{ asset('front/assets9/js/odometer.js') }}"></script>
<script src="{{ asset('front/assets8/js/pagenav.js') }}"></script>
<script src="{{ asset('front/assets9/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/wow.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/parallax-scroll.js') }}"></script>
<script src="{{ asset('front/assets9/js/jquery.cssslider.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('front/assets9/js/script.js') }}"></script>
@php
    $mainbs = [];
