                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                            <h3 class="tp-login-title">{{__('Login')}}</h3>
                            <p>{{__("Don't have an account?")}} <span><a href="{{route('user-register')}}">{{__('Create a free account')}}</a></span></p>
                        </div>
                        <div class="tp-login-option">
                            ...
                            <div class="tp-login-mail text-center mb-40">
                                <p>{{__('or Sign in with')}} <a href="#">{{__('Email')}}</a></p>
                            </div>
                            <form id="loginForm" action="{{route('user.login')}}" method="POST">
                                ...
                                <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-30">
                                    <div class="tp-login-remeber">
                                        ...
                                        <label for="remeber">{{__('Remember me')}}</label>
                                    </div>
                                ...
                                <div class="tp-login-bottom">
                                    <button type="submit" class="tp-login-btn w-100">{{__('LOG IN')}}</button>
                                </div>
                            </form>
                        </div>
                    </div>
