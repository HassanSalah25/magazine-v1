              ...
              <div class="pricing_box text-center mx-0">
                <div class="pricing_title">
                  ...
                  @if ($bex->recurring_billing == 1)
                    <p class="text-capitalize">{{$package->duration == 'quarterly' ? __('Quarterly') : __('Yearly')}}</p>
                  @endif
                </div>
                <div class="pricing_price">
                  <h3>{{$bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : ''}}
                    {{(int)$package->price}} {{$bex->base_currency_symbol_position == 'right' ? $bex->base_currency_symbol : ''}}
                  </h3>
                </div>
