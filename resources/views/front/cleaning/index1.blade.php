            ...
            <div class="price-carousel-active pricing-slick">
                @foreach ($packages as $key => $package)
                    <div class="single-price-item text-center">
                        ...
                        <h1 class="bg-1" style="background: #{{$package->color}};">{{$bex->base_currency_symbol_position == 'left' ? $bex->base_currency_symbol : ''}}{{(int)$package->price}}{{$bex->base_currency_symbol_position == 'right' ? $bex->base_currency_symbol : ''}}</h1>
