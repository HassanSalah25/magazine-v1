...
@section('content')
    ...
    <!-- hero area start -->
    <div class="tp-contact-main-ptb p-relative" data-background="{{ asset('front/assets/img/team/team-bg.png') }}">
                ...
                <div class="col-xl-12">
                    <div class="ar-hero-title-box tp_fade_anim" data-delay=".3">
                        <div class="ar-about-us-4-title-box d-flex align-items-center mb-20">
                            <span class="tp-section-subtitle pre tp_fade_anim">{{ $bs->contact_subtitle }}</span>
                        ...
                        <h3 class="tp-career-title fs-100 pb-30">{{$bs->contact_title}}</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="tp-contact-main-funfact-wrap">
                            <div class="crp-hero-funfact-wrap crp-hero-funfact-bg z-index-1 p-relative tp_fade_anim ar-about-funfact-color" data-delay=".5" data-background="{{ asset('front/assets/img/home-09/hero/funfact-bg-shape-2.png') }}">
                                <div class="crp-hero-funfact-line d-none d-xl-inline-block"></div>
                                <div class="crp-hero-funfact-img">
                                    <img src="{{ asset('front/assets/img/home-09/hero/funfact-circle-shape-2.png') }}" alt="">
                                </div>
                                ...
                                <div class="ar-about-funfact-item-box mb-35">
                                    <div class="ar-about-funfact-item d-flex align-items-center">
                                        ...
                                        <div class="ar-about-funfact-item-content">
                                            <p> {{ __('Call Us Directly') }}</p>
                                            @php $phones = explode(',', $bex->contact_numbers); @endphp
                                            @foreach ($phones as $phone)
                                            <a class="tp-line-white" href="tel:{{ $phone }}">{{ $phone }}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                    <div class="ar-about-funfact-item d-flex align-items-center">
                                        ...
                                        <div class="ar-about-funfact-item-content">
                                            ...
                                            @foreach ($mails as $mail)
                                                <a class="tp-line-white" href="mailto:{{ $mail }}">{{ $mail }}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                    <div class="ar-about-funfact-item d-flex align-items-center">
                                        ...
                                        <div class="ar-about-funfact-item-content">
                                            <a class="tp-line-white" target="_blank" href="https://wa.me/{{$bex->whatsapp_number}}">{{ __('Start Chat') }}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="ar-about-funfact-item-bottom">
                                    <p>{{__('See our')}} <span><a>{{ __('Refund Policies') }}</a></span> {{ __('or') }} <span><a href="{{ route('front.faq') }}">{{ __('FAQ') }}</a></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
{{--                </div>--}}
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3455.1780048614746!2d31.137361874584236!3d30.00304477494443!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1458456c0c038b8d%3A0x780c651cbdf08e7!2sSEO%20Wolves%20Agency!5e0!2m2!1sen!2seg!4v1752797368460!5m2!1sen!2seg" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
    <!-- inner map area end -->
                ...
                <div class="col-lg-6">
                    <div class="tp-contact-form-heading tp_fade_anim mb-50">
                        <div class="ar-about-us-4-title-box d-flex align-items-center mb-15">
                            <span class="tp-section-subtitle pre">{{convertUtf8($bs->contact_form_subtitle)}}
                              </span>
                            <div class="ar-about-us-4-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="81" height="9" viewBox="0 0 81 9" fill="none">
                        ...
                        <h3 class="tp-section-title lts">  {{convertUtf8($bs->contact_form_title)}}</h3>
                    </div>
                </div>
                <div class="col-lg-6">
