...
<div class="page-header">
    <h4 class="page-title">Create Dynamic Section</h4>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form action="{{ route('admin.dynamic-sections.store') }}" method="POST">
                @csrf
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="template_type" required>
                                    ...
                                    <option value="template_1" {{ old('type') == 'template_1' ? 'selected' : '' }}>
                                        Template 1 (Opinions Style)
                                    </option>
                                    <option value="template_2" {{ old('type') == 'template_2' ? 'selected' : '' }}>
