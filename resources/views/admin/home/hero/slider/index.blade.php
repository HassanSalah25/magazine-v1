        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        @if (!empty($langs))
                        <select name="language" class="form-control custom-select" onchange="window.location='{{url()->current() . '?language='}}'+this.value">
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center">
                                        <a class="btn btn-secondary btn-sm mr-2" href="{{route('admin.slider.edit', $slider->id) . '?language=' . request()->input('language') . '&id=' . request()->input('id')}}">
