        ...
        <div class="card-body pt-5 pb-4">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" action="{{route('admin.herosection.update', [$lang_id , 'id' => request('id')])}}" method="post">
                @csrf
                {{-- Image Part --}}
                ...
                <div class="form-group">
                    ...
                    <div class="thumb-preview" id="thumbPreview2">
                        <img src="{{asset('assets/front/img/' . ($abe->hero_bg2 ?? ''))}}" alt="Second Image">
                    </div>
                    <br>
                    <br>


                    <input id="fileInput2" type="hidden" name="image2">
                    <button id="chooseImage2" class="choose-image btn btn-primary" type="button" data-multiple="false" data-toggle="modal" data-target="#lfmModal2">Choose Second Image</button>
              ...
              <div class="row">
                  <div class="col-lg-6">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="hero_section_text2" value="{{$abe->hero_section_text2 ?? ''}}">
                          <p id="errhero_section_text2" class="em text-danger mb-0"></p>
                      </div>
                  </div>
                  <div class="col-lg-6">
                      <div class="form-group">
                          <label for="">Text 3</label>
                          <input type="text" class="form-control" name="hero_section_text3" value="{{$abe->hero_section_text3 ?? ''}}">
                          <p id="errhero_section_text3" class="em text-danger mb-0"></p>
                      </div>
                  </div>
              </div>
