          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                  ...
                  <div class="form-group">
                      <label for="">Precent Value</label>
                      <input type="number" class="form-control ltr" name="percent_value" value="{{ $feature->percent_value }}" placeholder="Enter Precent Value">
                      <p id="errpercent_value" class="mb-0 text-danger em"></p>
                      <p class="text-warning"><small>It will be shown in the feature section.</small></p>
                  </div>
              </div>
            </div>
          </div>
