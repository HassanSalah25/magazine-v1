          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="ajaxForm" action="{{route('admin.introsection.update', $lang_id)}}" method="post">
                  <input type="hidden" name="id" value="{{ $landingpage_id }}">
                ...
                <div class="row">
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                          <div class="form-group">
                              <label for="">Scrolling Text </label>
                              <input name="intro_section_scrolling_text" class="form-control" value="{{$abs->intro_section_scrolling_text}}">
                              <p id="errintro_section_scrolling_text" class="em text-danger mb-0"></p>
                          </div>
                      </div>
                  </div>
