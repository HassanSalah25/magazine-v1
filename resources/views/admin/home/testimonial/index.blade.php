    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <form class="" action="{{route('admin.testimonialtext.update', $lang_id)}}" method="post">
                <input type="hidden" name="page_id" value="{{ request()->input('id') }}">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="thumb-preview" id="thumbPreview2">
                                    <img src="{{asset('assets/front/img/testimonials/'.$abex->testimonial_section_image)}}" alt="Image">
                                </div>
                                <br>
                                <br>


                                <input id="fileInput2" type="hidden" name="testimonial_section_image">
