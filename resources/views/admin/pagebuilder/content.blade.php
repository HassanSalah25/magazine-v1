...
<html>
  ...
  <body>
    ...
    @if(!empty($creativeServicesSec))
    var blockManager = editor.BlockManager;
        blockManager.add('creative_services', {
        label: 'Creative Services',
        attributes: {class:'fa fa-cogs'},
        content: {
            components: `{!! $creativeServicesSec !!}`
        },
        category: 'Theme Sections',
        render: ({ el }) => {
            const btn = document.createElement('a');
...
@if(!empty($workAreaSec))
    var blockManager = editor.BlockManager;
        blockManager.add('workarea', {
        label: 'Work Area',
        attributes: {class:'fa fa-globe'},
        content: {
            components: `{!! $workAreaSec !!}`
        },
        category: 'Theme Sections',
        render: ({ el }) => {
            const btn = document.createElement('a');
...
//   Statistics Section
    @if(!empty($funfactSec))
    var blockManager = editor.BlockManager;
        blockManager.add('fun_statistics', {
        label: 'Fun Statistics',
        attributes: {class:'fa fa-globe'},
        content: {
            components: `{!! $funfactSec !!}`
        },
        category: 'Theme Sections',
        render: ({ el }) => {
            const btn = document.createElement('a');
