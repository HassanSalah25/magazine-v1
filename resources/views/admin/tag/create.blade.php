        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">Create Tag</div>
                ...
                <div class="card-body pt-5 pb-5">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <form id="ajaxForm" class="" action="{{route('admin.tag.store')}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        {{-- Featured Image Part --}}
                                ...
                                <div class="row">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="tagContent" class="form-control summernote"
                                                          id="summernote1" name="content"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="meta_title" value=""
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="canonical" value=""
    ...
    <script>
        $(document).ready(function () {
            ...
            $("select[name='language_id']").on('change', function () {
                ...
                let langid = $(this).val();
                let url = "{{url('/')}}/admins/tag/" + langid + "/getservices";
                // console.log(url);
            ...
            // translatable tags will be available if the selected language is not 'Default'
