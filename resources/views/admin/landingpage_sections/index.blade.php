                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(isset($status) && $section['status'])
                                                        ...
                                                        @endif
                                                        " name="{{ $section['status'] }}" onchange="document.getElementById('statusForm{{$section['id']}}').submit();">
                                                ...
                                                <td>
                                                    @if($section['route'])
                                                        <a href="{{ route($section['route'],['id'  => $landingpage_id ,'language' => $selectedLang]) }}" class="btn btn-primary btn-sm">
