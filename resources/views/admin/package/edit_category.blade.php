    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.package.update_category') }}" method="post">
          ...
          <div class="form-group">
            <label for="">Show in Home Page Only*</label>
            <select name="show_in_home" id="inshow_in_home" class="form-control ltr">
              <option disabled>Select an Option</option>
              <option value="0">No (Show in Packages Page)</option>
              <option value="1">Yes (Show Only in Home Page)</option>
            </select>
            <p id="eerrshow_in_home" class="mt-1 mb-0 text-danger em"></p>
            <p class="text-info mt-2">
              <small>If "Yes" is selected, this category will only appear on the home page and not in the packages page.</small>
            </p>
          </div>
