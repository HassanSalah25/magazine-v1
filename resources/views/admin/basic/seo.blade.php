          ...
          <div class="card-body pt-5 pb-5">
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>Meta Keywords for Our Story Page</label>
                        <input class="form-control" name="our_story_meta_keywords" value="{{$abe->our_story_meta_keywords}}"
                               placeholder="Enter meta keywords" data-role="tagsinput">
                    </div>
                    <div class="form-group">
                        <label>Meta Description for Our Story Page</label>
                        <textarea class="form-control" name="our_story_meta_description" rows="5"
                                  placeholder="Enter meta description">{{$abe->our_story_meta_description}}</textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label>Meta Keywords for Tags Page</label>
                        <input class="form-control" name="tags_meta_keywords" value="{{$abe->tags_meta_keywords}}"
                               placeholder="Enter meta keywords" data-role="tagsinput">
                    </div>
                    <div class="form-group">
                        <label>Meta Description for Tags Page</label>
                        <textarea class="form-control" name="tags_meta_description" rows="5"
                                  placeholder="Enter meta description">{{$abe->tags_meta_description}}</textarea>
                    </div>
                </div>
