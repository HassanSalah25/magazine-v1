            ...
            <div class="row">
              <div class="col-lg-8 offset-lg-2">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                    <label>Service Shape Image **</label>
                    <br>
                    <div class="thumb-preview" id="thumbPreview1">
                        <img src="{{ $abs->service_shape_image ? asset('assets/front/img/services/' . $abs->service_shape_image) : asset('assets/admin/img/noimage.jpg') }}" alt="Service Shape Image">
                    </div>
                    <br>
                    <br>
                    <input id="fileInput1" type="hidden" name="service_shape_image" value="{{ $abs->service_shape_image }}">
                    <button id="chooseImage1" class="choose-image btn btn-primary" type="button" data-multiple="false" data-toggle="modal" data-target="#lfmModal1">Choose Image</button>
                    <p class="text-warning mb-0">JPG, PNG, JPEG, SVG images are allowed</p>
                    @if ($errors->has('service_shape_image'))
                    <p class="text-danger mb-0">{{$errors->first('service_shape_image')}}</p>
                    @endif
                  </div>
                  <div class="form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="our_story_title"
                               value="{{empty(old('our_story_title')) ? $abex->our_story_title : old('our_story_title')}}">
                        @if ($errors->has('our_story_title'))
                            <p class="mb-0 text-danger">{{$errors->first('our_story_title')}}</p>
                        @endif
                    </div>
                    <div class="form-group col-lg-6">
                        <label>Our Story Subtitle **</label>
                        <input class="form-control" name="our_story_subtitle"
                               value="{{empty(old('our_story_subtitle')) ? $abex->our_story_subtitle : old('our_story_subtitle')}}">
                        @if ($errors->has('our_story_subtitle'))
                            <p class="mb-0 text-danger">{{$errors->first('our_story_subtitle')}}</p>
                        @endif
                    </div>
                  <div class="form-group col-lg-6">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input class="form-control" name="tags_title"
                               value="{{empty(old('tags_title')) ? $abex->tags_title : old('tags_title')}}">
                        @if ($errors->has('tags_title'))
                            <p class="mb-0 text-danger">{{$errors->first('tags_title')}}</p>
                        @endif
                    </div>
                    <div class="form-group col-lg-6">
                        <label>Tags Subtitle **</label>
                        <input class="form-control" name="tags_subtitle"
                               value="{{empty(old('tags_subtitle')) ? $abex->tags_subtitle : old('tags_subtitle')}}">
                        @if ($errors->has('tags_subtitle'))
                            <p class="mb-0 text-danger">{{$errors->first('tags_subtitle')}}</p>
                        @endif
                    </div>
                  <div class="form-group col-lg-6">
