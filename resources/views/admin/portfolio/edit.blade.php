                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <button id="chooseImage2" class="choose-image btn btn-primary" type="button"
                                                    data-multiple="true"
                                                    data-toggle="modal" data-target="#lfmModal2">Choose Images
                                            </button>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="thumb-preview" id="thumbPreview3">
                                                <img
                                                    src="{{ $portfolio->client_image ? asset('assets/front/img/portfolios/featured/' . $portfolio->client_image) : asset('assets/admin/img/noimage.jpg')}}"
                                                    alt="Client Image">
                                            </div>
                                            <br><br>

                                            <input id="fileInput3" type="hidden" name="client_image">
                                            <button id="chooseImage3" class="choose-image btn btn-primary" type="button"
                                                    data-multiple="false"
                                                    data-toggle="modal" data-target="#lfmModal3">Choose Image
                                            </button>
                                            ...
                                            <!-- Client Image Modal -->
                                            <div class="modal fade lfm-modal" id="lfmModal3" tabindex="-1" role="dialog"
                                                 aria-labelledby="lfmModalTitle" aria-hidden="true">
                                                <i class="fas fa-times-circle"></i>
                                                <div class="modal-dialog modal-dialog-centered modal-lg"
                                                     role="document">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control multiselect" name="scategories[]" multiple>
                                                <option value="" disabled>Select a service</option>
                                                @foreach ($services as $key => $service)
                                                    <option value="{{$service->id}}"
                                                        {{ in_array($service->id, old('scategories', $portfolio->scategories->pluck('id')->toArray() ?? [])) ? 'selected' : '' }}
                                                    >
                                                        {{$service->name}}</option>
                                                @endforeach
                                            </select>
                                            <p id="errscategories" class="mb-0 text-danger em"></p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="startDate" type="text" class="form-control datepicker"
                                                   name="start_date"
                                                   value="{{$portfolio->start_date}}" placeholder="Enter start date"
                                                   autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control ltr" name="status">
                                                ...
                                                <option
                                                    value="In Progress" {{$portfolio->status == 'In Progress' ? 'selected' : ''}}>
                                                    In Progress
                                                </option>
                                                <option
                                                    value="Completed" {{$portfolio->status == 'Completed' ? 'selected' : ''}}>
                                                    Completed
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning mb-0"><small>The higher the serial number is, the
                                                    later the portfolio will be
                                                    shown.</small></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="portContent" class="form-control summernote" name="content"
                                                      rows="8"
                                                      placeholder="Enter content"
                                                      data-height="300">{{replaceBaseUrl($portfolio->content)}}</textarea>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="col-12 mb-2">
                                                <label for="brand_content"><strong>Brand Content **</strong></label>
                                                <textarea id="brand_content" class="form-control summernote"
                                                          name="brand_content" rows="8"
                                                          placeholder="Enter brand content"></textarea>
                                                <p id="errbrand_content" class="mb-0 text-danger em"></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
