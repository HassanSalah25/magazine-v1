                  ...
                  <div class="col-lg-6">
                      <div class="form-group">
                          ...
                          <div class="thumb-preview" id="thumbPreview3">
                              <img src="{{asset('assets/admin/img/noimage.jpg')}}" alt="Client Image">
                          </div>
                          <br><br>

                          <input id="fileInput3" type="hidden" name="client_image">
                          <button id="chooseImage3" class="choose-image btn btn-primary" type="button" data-multiple="false"
                                  data-toggle="modal" data-target="#lfmModal3">Choose Image</button>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <select id="services" class="form-control multiselect"
                            name="scategories[]" multiple disabled>
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    <div class="col-12 mb-2">
                        ...
                        <textarea id="brand_content" class="form-control summernote" name="brand_content" rows="8" placeholder="Enter brand content"></textarea>
  ...
  $(document).ready(function() {
    // {{url('laravel-filemanager')}}?serial=2
       ...
       $("select[name='language_id']").on('change', function() {
           ...
           let langid = $(this).val();
           let url = "{{url('/')}}/admins/portfolio/" + langid + "/getservices";
           // console.log(url);
           $.get(url, function(data) {
               // console.log(data);
               let options = `<option value="" disabled >Select a service</option>`;
