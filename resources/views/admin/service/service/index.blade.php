...
<div class="row">
    ...
    <label class="status-toggle">
        ...
        <div class="status-toggle-knob">
            ...
            <div class="status-toggle-face status-toggle-face--on"></div>
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{$service->faqs->count()}} FAQs</span>
                                        </td>
    ...
    @csrf
    <input type="hidden" name="service_id" value="{{ $service->id }}">
    {{-- hidden input عشان لو الـ checkbox unchecked يبعت 0 --}}
    ...
    <label class="status-toggle">
        <input type="checkbox"
               name="sidebar"
               value="1"
               onchange="document.getElementById('statusForm{{$service->id}}').submit();"
               {{ $service->sidebar == 1 ? 'checked' : '' }}>
        <div class="status-toggle-track"></div>
        <div class="status-toggle-knob">
            <div class="status-toggle-face status-toggle-face--off"></div>
            <div class="status-toggle-face status-toggle-face--on"></div>
        ...
        <div class="modal-content">
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.service.store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="slug" placeholder="Enter slug" value="">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" name="publish_data" placeholder="Enter Date" />
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="canonical" value="" placeholder="Enter canonical">
                    <p id="errcanonical" class="mb-0 text-danger em"></p>
                </div>
                <div class="form-group">
                    <label>Redirect Url</label>
                    <input class="form-control" name="redirect_url" value="" placeholder="Enter redirect url">
                    <p id="errcredirect_url" class="mb-0 text-danger em"></p>
                </div>
            </form>
        </div>
...
<script>
    function loadCategories() {
        ...
        let url = "{{url('/')}}/admins/service/" + langid + "/getcats";
        // console.log(url);
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        new TomSelect('#tags', {
            ...
            maxItems: null,
            create: false, // users can't create new tags
            persist: false
        });
    });
</script>
