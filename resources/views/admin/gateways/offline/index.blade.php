      ...
      <div class="card">
         <div class="card-header">
            <div class="row">
               ...
               <div class="col-lg-3">
                  @if (!empty($langs))
                  <select name="language" class="form-control text-center" onchange="window.location='{{url()->current() . '?language='}}'+this.value">
...
<td>
    <form id="productForm{{$ogateway->id}}" class="d-inline-block" action="{{ route('admin.offline.status') }}" method="post">
        ...
        <input type="hidden" name="product_checkout_status" value="0">

        <label class="status-toggle">
            <input type="checkbox"
                   name="product_checkout_status"
                   value="1"
                   onchange="document.getElementById('productForm{{$ogateway->id}}').submit();"
                   {{ $ogateway->product_checkout_status == 1 ? 'checked' : '' }}>
...
<td>
    <form id="packageForm{{$ogateway->id}}" class="d-inline-block" action="{{ route('admin.offline.status') }}" method="post">
        ...
        <input type="hidden" name="package_order_status" value="0">

        <label class="status-toggle">
            <input type="checkbox"
                   name="package_order_status"
                   value="1"
                   onchange="document.getElementById('packageForm{{$ogateway->id}}').submit();"
                   {{ $ogateway->package_order_status == 1 ? 'checked' : '' }}>
            <div class="status-toggle-track"></div>
            <div class="status-toggle-knob"></div>
        </label>
    </form>
...
<td>
    <form id="courseForm{{$ogateway->id}}" class="d-inline-block" action="{{ route('admin.offline.status') }}" method="post">
        ...
        <input type="hidden" name="course_checkout_status" value="0">

        <label class="status-toggle">
            <input type="checkbox"
                   name="course_checkout_status"
                   value="1"
                   onchange="document.getElementById('courseForm{{$ogateway->id}}').submit();"
                   {{ $ogateway->course_checkout_status == 1 ? 'checked' : '' }}>
            <div class="status-toggle-track"></div>
            <div class="status-toggle-knob"></div>
        </label>
    </form>
...
<td>
    <form id="donationForm{{$ogateway->id}}" class="d-inline-block" action="{{ route('admin.offline.status') }}" method="post">
        ...
        <input type="hidden" name="donation_checkout_status" value="0">

        <label class="status-toggle">
            <input type="checkbox"
                   name="donation_checkout_status"
                   value="1"
                   onchange="document.getElementById('donationForm{{$ogateway->id}}').submit();"
                   {{ $ogateway->donation_checkout_status == 1 ? 'checked' : '' }}>
            <div class="status-toggle-track"></div>
            <div class="status-toggle-knob"></div>
        </label>
    </form>
...
<td>
    <form id="eventForm{{$ogateway->id}}" class="d-inline-block" action="{{ route('admin.offline.status') }}" method="post">
        ...
        <input type="hidden" name="event_checkout_status" value="0">

        <label class="status-toggle">
            <input type="checkbox"
                   name="event_checkout_status"
                   value="1"
                   onchange="document.getElementById('eventForm{{$ogateway->id}}').submit();"
                   {{ $ogateway->event_checkout_status == 1 ? 'checked' : '' }}>
            <div class="status-toggle-track"></div>
            <div class="status-toggle-knob"></div>
        </label>
    </form>
