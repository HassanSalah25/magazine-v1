...
class TenantBasicSettingsDataSeeder extends Seeder
{
    /**
    ...
    {
        $tenantConnection = "tenant_{$tenantId}";
    ...
    /**
     * Seed basic_settings table with comprehensive data
     */
    private function seedBasicSettings(string $connection): void
    {
        ...
        if (Schema::connection($connection)->hasTable('basic_settings')) {
            // Clear existing data
            DB::connection($connection)->table('basic_settings')->truncate();
            
            // Insert new data
            foreach ($basicSettingsData as $data) {
                DB::connection($connection)->table('basic_settings')->insert($data);
            }
    ...
    /**
     * Seed basic_settings_extended table with comprehensive data
     */
    private function seedBasicSettingsExtended(string $connection): void
    {
        ...
        // Check if table exists before inserting
        if (Schema::connection($connection)->hasTable('basic_settings_extended')) {
            // Clear existing data
            DB::connection($connection)->table('basic_settings_extended')->truncate();
            
            // Insert new data
            foreach ($extendedSettingsData as $data) {
                DB::connection($connection)->table('basic_settings_extended')->insert($data);
            }
    ...
    /**
     * Seed basic_settings_extra table with comprehensive data
     */
    private function seedBasicSettingsExtra(string $connection): void
    {
        $extraSettingsData = [
            [
                ...
                'client_feedback_title' => null,
                'client_feedback_subtitle' => null,
                'course_title' => null,
        ...
        // Check if table exists before inserting
        if (Schema::connection($connection)->hasTable('basic_settings_extra')) {
            // Clear existing data
            DB::connection($connection)->table('basic_settings_extra')->truncate();
            
            // Insert new data
            foreach ($extraSettingsData as $data) {
                DB::connection($connection)->table('basic_settings_extra')->insert($data);
            }
